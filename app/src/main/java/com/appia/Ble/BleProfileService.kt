...
abstract class BleProfileService : Service(), BleManagerCallbacks {
    private var bleManager: BleManager<BleManagerCallbacks>? = null
     ...
     */
    protected open val binder: LocalBinder?
    ...
    override fun onCreate() {
        ...
        bleManager = initializeManager() as BleManager<BleManagerCallbacks>
     ...
     */
    protected abstract fun initializeManager(): BleManager<*>?
     ...
     */
    protected open fun onServiceStarted() {
        // empty default implementation
    }
     ...
     */
    protected open fun stopWhenDisconnected(): Boolean {
        return true
    }
    ...
    companion object {
        ...
        @Deprecated("")
        val BROADCAST_BATTERY_LEVEL = "com.appia.bioland.BROADCAST_BATTERY_LEVEL"
        ...
        @Deprecated("")
        val EXTRA_BATTERY_LEVEL = "com.appia.bioland.EXTRA_BATTERY_LEVEL"
